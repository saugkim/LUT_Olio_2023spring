...
public class BottomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textView = view.findViewById(R.id.tvImportantThingsInBottom);
        textView.setText(getImportantItems());
    ...
    public String getImportantItems() {
        ...
        return sb.toString().isEmpty() ? "important things" : sb.toString();
    }
}